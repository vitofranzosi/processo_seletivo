...
def test_swapping_the_whole_schedule_is_done_entity_by_entity(
    ...
    novo_evento = {
        ...
        "order": 1,
        "status": "PLANEJADO",
        # Onde o Evento acontece. Entrou na forma publicada com a `026`, que o encontrou emitido
        # pelo `publish_edital` e declarado em lugar nenhum — e vale a mesma regra do campo abaixo.
        "location": "",
