...
| RC-54 | conferência §3/§7 · 044 "Riscos e lacunas" | o filtro de concorrência repete "PcD" por Perfil sem dizer de qual | **PR #172** | `interface/templates/interface/inscricoes.html:53-57` | IMPLEMENTADO, MAS NÃO VALIDADO | sim | C | mesclar o #172 (decisão do usuário) | 6, 5 |
