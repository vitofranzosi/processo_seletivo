...
- [ ] T061 [US3] Os quatro casos de identificador alheio são recusados com `409` — modalidade de outro Perfil, modalidade de outro Edital, Regra de outra Modalidade **do mesmo Perfil** e Regra de outro Edital —, em `backend/tests/contract/test_edital_draft_api.py`
