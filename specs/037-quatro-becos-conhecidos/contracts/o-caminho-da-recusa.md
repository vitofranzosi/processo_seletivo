# Contrato — qual recusa leva a qual caminho

A tela do corte exibe **três** recusas do domínio, e hoje anexa **o mesmo caminho** às três. Duas
delas se resolvem na classificação; a terceira, não.

## Como fica

| Recusa | O que falta | Caminho |
|---|---|---|
...
Hoje a terceira linha é inalcançável: sem regra de corte, o caminho até esta tela não é oferecido.
**A feature a torna alcançável** — e entregaria, no fim do caminho que ela abre para remover um beco,
um segundo caminho que não resolve.
...
- Quem **não alcança** a classificação continua sem receber destino nenhum.
- O marco **com** regra continua com o caminho de hoje, nas duas recusas de ordem.
- Nenhuma recusa nova é criada, e nenhuma mensagem do domínio é reescrita.
