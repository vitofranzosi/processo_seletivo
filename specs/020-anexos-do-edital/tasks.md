...
- [X] T022 [US1] Servir o artefato de rascunho pela interface administrativa, exigindo ator no escopo institucional e autorização de elaboração, revisão ou homologação (FR-017)
...
- [X] T025 [US1] Acrescentar as regras impeditivas `attachment_label_required` e `attachment_artifact_missing`, e o aviso `attachment_duplicate_label`, em `backend/processo_seletivo/editais/domain/validation.py`, registradas em `validate_for_publication` (FR-005, FR-026)
