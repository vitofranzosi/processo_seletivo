...
- [ ] T022 [US2] Acrescentar ao mesmo arquivo o caso de `FR-481`: a recusa **nomeia as bases que teriam servido** — a permissão de gerir a comissão **e** a presidência daquele Processo, quando as duas serviriam — e declara que nada foi alterado. Nomear só uma manda a pessoa pedir metade do que resolve
