...
| **FR-183** | T017, T018c | `tests/unit/editais/test_regra_de_corte.py` | sim |
...
| **FR-202** | T071 | `tests/integration/classificacao/test_faixa_seguinte.py` | sim |
| **FR-203** | T073 | `tests/integration/classificacao/test_faixa_seguinte.py` | sim |
| **FR-204** | T073, T073a | `tests/integration/classificacao/test_faixa_seguinte.py` | sim |
...
| **FR-215** | T078 | `tests/integration/classificacao/test_corte_obsoleto.py` | sim |
...
| **FR-220** | T054 | `classificacao/application/emissao_do_corte.py` | sim |
| **FR-221** | T051 | `tests/interface/test_corte.py` | sim |
| **FR-222** | T054, T089 | `classificacao/application/emissao_do_corte.py`, `tests/integration/classificacao/test_reproducao_do_corte.py` | sim |
...
| **SC-070** | T089 | `tests/integration/classificacao/test_reproducao_do_corte.py` | sim |
...
| Requisito | Tarefas | Onde vive | Fechado |
|---|---|---|---|
| **UX-024** | T020, T050, T091, T096 | `tests/interface/test_corte.py` | **não** |
