...
- [ ] T042a [P] [US2] Em `backend/tests/integration/classificacao/test_emissao_do_corte.py`, **marco que não antecede Etapa alguma**: a emissão é aceita, o ato existe, e o gate de participação não incide sobre Etapa nenhuma. *É o corte de suplentes — a cláusula 6.10 do 77, a 8.13 do 57 e a 8.12 do 28 —, que existe para a análise documental e para a chamada, e não para uma Etapa seguinte. Três dos quatro Editais do alvo o publicam, e a Assumption da spec que o declara legítimo não tinha teste nenhum*
